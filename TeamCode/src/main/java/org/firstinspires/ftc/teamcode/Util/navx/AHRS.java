...
//
//    private PinpointLocalizer sensor = null;
...
//
//    protected AHRS(PinpointLocalizer sensor,
...
//     */
//    public static AHRS getInstance(PinpointLocalizer sensor,
...
//
//            if ( enable_logging ) {
//                Log.i("navx_ftc", "Beginning communication with navX-Model sensor " + sensor.getPinpoint().getDeviceName() + " at I2C address " + sensor.getPinpoint().getDeviceID());
//                Log.i("navx_ftc", "Firmware version:  " + sensor.getPinpoint().getDeviceVersion());
//            }
//
//            setConnected(false);
//
...
//                        TimestampedData board_data = sensor.getPinpoint().getDeviceClient().readTimeStamped(sensor.getPinpoint().;
//                        );
