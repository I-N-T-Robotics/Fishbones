...
@Autonomous(name = "DDogsAutoBlue", group = "Autos")
public class DDogsAutoBlue extends ActionOpMode {
    ...
    private final Pose startPose = new Pose(56.129, 8.129, Math.toRadians(90));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            shootPreload = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.129, 8.129), new Pose(58.258, 12.000))
                    )
            ...
            intake1P1 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(58.258, 12.000),
                                    new Pose(64.645, 21.871),
                                    new Pose(48.194, 20.323)
                            )
                    )
            ...
            intake1P2 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(48.194, 20.323),
                                    new Pose(11.806, 16.452),
                                    new Pose(8.516, 24.968)
                            )
                    )
            ...
            intake = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(8.516, 24.968),
                                    new Pose(10.452, 20.903),
                                    new Pose(9.097, 8.516)
                            )
                    )
            ...
            move = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(58.258, 12.000), new Pose(33.871, 10.839))
                    )
