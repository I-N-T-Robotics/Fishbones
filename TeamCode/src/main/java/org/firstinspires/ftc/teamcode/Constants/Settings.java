...
public interface Settings {
    ...
    public interface Swerve {
        public interface FrontRight {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(204.5);
        ...
        public interface FrontLeft {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(102.5);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * +0.5, LENGTH * +0.5);
        }
        public interface BackRight {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(214.8);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * -0.5, LENGTH * -0.5);
        }
        public interface BackLeft {
            ...
            String ID = "Back Left";
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(317.7);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * -0.5, LENGTH * +0.5);
        }
