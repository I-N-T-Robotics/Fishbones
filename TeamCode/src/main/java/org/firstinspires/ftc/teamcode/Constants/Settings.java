...
public interface Settings {
    ...
    public interface Swerve {
        public interface FrontRight {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(0);//130.4);
        ...
        public interface FrontLeft {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(0);//140.3);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * +0.5, LENGTH * +0.5);
        }
        public interface BackRight {
            ...
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(0);//165);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * -0.5, LENGTH * -0.5);
        }
        public interface BackLeft {
            ...
            String ID = "Back Left";
            Rotation2d ABSOLUTE_OFFSET = Rotation2d.fromDegrees(0);//172.2);
            Translation2d MODULE_OFFSET = new Translation2d(WIDTH * -0.5, LENGTH * +0.5);
        }
